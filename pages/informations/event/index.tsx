...
import Error from "@components/domain/informations/event/Error";
import Item from "@components/domain/informations/event/Item";
import Empty from "@components/domain/informations/event/Empty";
import Pagination from "@components/Pagination";
import { useEvent } from "hooks/swr/event";
...
const Event = () => {
  ...
  const { data, isError, isLoading } = useEvent(
    reqConfig,
    search,
    ...
    <AdminLayout>
      <div className="">
        <HeaderPagesInformation
          title="Event"
          uploadPagePath="/informations/event/add"
        />
