...
import Error from "@components/domain/informations/schoolarship/Error";
import Item from "@components/domain/informations/schoolarship/Item";
import Empty from "@components/domain/informations/schoolarship/Empty";
import Pagination from "@components/Pagination";
import { useSchoolarship } from "hooks/swr/schoolarship";
...
const Scholarship = () => {
  ...
  const { data, isError, isLoading } = useSchoolarship(
    reqConfig,
    search,
    ...
    <AdminLayout>
      <div className="">
        <HeaderPagesInformation
          ...
          uploadPagePath="/informations/schoolarship/add"
        />
