...
import Error from "@components/domain/informations/university/Error";
import Item from "@components/domain/informations/university/Item";
import Empty from "@components/domain/informations/university/Empty";
import Pagination from "@components/Pagination";
import { useUniversity } from "hooks/swr/university";
...
const Scholarship = () => {
  ...
  const { data, isError, isLoading } = useUniversity(
    reqConfig,
    search,
